...
void classification(std::string path_img_1, std::string path_NN);
void train(Data_loader data_train, Data_set data_val, std::string path_save_NN, int epochs, torch::Device device = torch::kCPU);
